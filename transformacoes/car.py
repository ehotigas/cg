...
class Poligon:
    _vertex: List[Point]
    def __init__(self, vertex: List[Point]) -> None:
        self._vertex = vertex
...
class Car:
    _center: Point
    _components: List[Circle | Poligon]
    def __init__(
        self,
        center: Point
    ) -> None:
    ...
    def display(
        ...
        Poligon([
            Point(self._center.x - 40, self.center.y - 10),
            Point(self._center.x + 40, self.center.y - 10),
            Point(self._center.x + 40, self.center.y + 10),
            Point(self._center.x - 40, self.center.y + 10),
        ])
        glRotatef(10, 0, 0, 1)
        Circle(Point(self._center.x - 30, self.center.y - 10), 20).draw()
        Circle(Point(self._center.x + 30, self.center.y - 10), 20).draw()
        glLoadIdentity()
...
class Window:
    ...
    def __init__(
        ...
        self._car = Car(Point(self._width/2, self._height/2))
